  ...
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('FavoriteArticles', {
      ...
      favorite_user_code: {
        ...
        allowNull: false,
        references: {
          model: 'Users', // Asegúrate que coincida con el nombre real de tu tabla de usuarios
          key: 'user_code'
        },
        onDelete: 'CASCADE',
        onUpdate: 'CASCADE'
      ...
      favorite_article_code: {
        ...
        allowNull: false,
        references: {
          model: 'Articles', // Asegúrate que coincida con el nombre real de tu tabla de artículos
          key: 'article_code'
        },
        onDelete: 'CASCADE',
        onUpdate: 'CASCADE'
